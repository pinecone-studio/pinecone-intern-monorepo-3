...
export const HotelsPage = () => {
  ...
  if (showAddHotel) return <AddHotel onBack={() => setShowAddHotel(false)} />;
  ...
  console.log(data);
  console.log('selected hotel', selectedHotelId);
              ...
              return (
                <tr key={hotel._id} className="border-t">
                  ...
                  <td className="px-4 py-3 flex items-center gap-2">
                    ...
                    {/* <button onClick={}>{hotel.hotelName}</button> */}
                    <button onClick={() => setSelectedHotelId(hotel._id)}>{hotel.hotelName}</button>
                  </td>
