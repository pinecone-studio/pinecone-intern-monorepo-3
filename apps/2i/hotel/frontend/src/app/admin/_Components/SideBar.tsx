  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r bg-white">
      ...
      <nav className="flex-1 px-3 py-4">
        <h3 className="mb-2 px-2 text-xs font-semibold text-black uppercase">Menu</h3>
        <ul className="space-y-1">
          <li>
            <Link
              href="/admin/hotels"
              className={`flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-400 ${pathname === '/hotels' ? 'bg-blue-50 text-blue-600 font-medium' : 'text-black'}`}
            >
          ...
          <li>
            <Link
              href="/admin/guests"
              className={`flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-400 ${pathname === '/guests' ? 'bg-blue-50 text-blue-600 font-medium' : 'text-black'}`}
            >
