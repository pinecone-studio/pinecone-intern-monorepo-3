...
const Footer: React.FC<Props> = ({ className }) => {
  return (
    <footer className={`mt-[24px] w-full bg-[#0e0e0e] ${className ?? ''}`}>
      <div className="mx-auto flex max-w-[1200px] items-center justify-between px-[16px] py-[48px] text-[12px] text-gray-400">
        <div>
          ...
          <div className="mt-[12px] text-[12px] text-gray-500">© 2024 Booking Mongolia. All Rights Reserved.</div>
        </div>
            ...
            <div className="flex items-start gap-[24px]">
              <div className="flex items-center gap-[8px]">
                ...
                <div>
                  ...
                  <div className="font-light text-gray-300">support@ticketinbooking.mn</div>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
                ...
                <div>
                  ...
                  <div className="font-light text-gray-300">+976 (11) 123-4567</div>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
                <Headset size={16} className="text-gray-500" />
                <div>
                  <div className="font-light text-gray-500">Customer Support:</div>
                  <div className="font-light text-gray-300">Available 24/7</div>
                </div>
              </div>
            </div>
          </div>
