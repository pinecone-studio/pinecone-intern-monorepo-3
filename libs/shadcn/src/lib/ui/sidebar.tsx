...
const SidebarTrigger=({ className, onClick, ...props }: React.ComponentProps<typeof Button>)=> {
  ...
  const handelEvent = (event:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        onClick?.(event)
        toggleSidebar()
}
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          "absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none",
  ...
  ({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
          "peer-hover/menu-button:text-sidebar-accent-foreground absolute right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none",
          "transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
          "after:absolute after:-inset-2 md:after:hidden", // Increases the hit area on mobile
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          "[&>svg]:text-sidebar-accent-foreground flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2",
